...
namespace KerbalAlarmClock
{
    public static class KACResources
    {
        ...
        public static void loadGUIAssets()
        {
            ...
            try
            {
                KACUtils.LoadImageFromGameDB(ref iconNorm, "img_iconNorm.tga");
                KACUtils.LoadImageFromGameDB(ref iconNormShow, "img_iconNormShow.tga");
                KACUtils.LoadImageFromGameDB(ref iconAlarm, "img_iconAlarm.tga");
                KACUtils.LoadImageFromGameDB(ref iconAlarmShow, "img_iconAlarmShow.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect100, "img_iconWarpEffect2_100.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect080, "img_iconWarpEffect2_080.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect060, "img_iconWarpEffect2_060.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect040, "img_iconWarpEffect2_040.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect020, "img_iconWarpEffect2_020.tga");
                KACUtils.LoadImageFromGameDB(ref iconWarpEffect000, "img_iconWarpEffect2_000.tga");
                KACUtils.LoadImageFromGameDB(ref iconPauseEffect100, "img_iconPauseEffect_100.tga");
                KACUtils.LoadImageFromGameDB(ref iconPauseEffect080, "img_iconPauseEffect_080.tga");
                KACUtils.LoadImageFromGameDB(ref iconPauseEffect060, "img_iconPauseEffect_060.tga");
                KACUtils.LoadImageFromGameDB(ref iconPauseEffect040, "img_iconPauseEffect_040.tga");
                KACUtils.LoadImageFromGameDB(ref iconPauseEffect020, "img_iconPauseEffect_020.tga");
                KACUtils.LoadImageFromGameDB(ref  iconPauseEffect000, "img_iconPauseEffect_000.tga");
                ...
                KACUtils.LoadImageFromGameDB(ref txtTooltipBackground, "txt_TooltipBackground.tga");
